...
const BinaryCheckbox = (props) =>{
    ...
    return(
        ...
        <div style={{display: 'flex', alignItems: 'baseline'}}>
            ...
            <label htmlFor="rb1" style={{paddingRight: '9px', position: 'relative', bottom: '6px'}}>{option[0]}</label>
        </div>
        <div>
            <div
                type="checkbox"
            ...
            <label htmlFor="rb2" style={{paddingRight: '9px', position: 'relative', bottom: '6px'}}>{option[1]}</label>
        </div>
        </div> 
    )
}
